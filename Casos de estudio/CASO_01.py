# -*- coding: utf-8 -*-
"""
FTES - Casos de analisis TFM. FTES.
CASO 01
@author: gumer freire
"""
...
# C01_ELU.import_DxfStructure('CASO_01/CASO_01.dxf')
...
# C01_ELU.set_P(75000, Memberfilter='Allmembers') #set the same pretension for all cables
...
# #Structure analysis
# C01_ELU.set_solverParameters(2000, 50, 5000)
# C01_ELU.calculate_structure()

# #Plot and export data
# C01_ELU.plotStructure()
# C01_ELU.export_Data('CASO_01/CASO_01_ELU.xlsx')
# C01_ELU.export_DxfStructure('CASO_01/CASO_01_ELU.dxf')
...
# C01_ELS.import_DxfStructure('CASO_01/CASO_01.dxf')
...
# C01_ELS.set_P(75000, Memberfilter='Allmembers') #set the same pretension for all cables
...
# #Structure analysis
# C01_ELS.set_solverParameters(2000, 50, 5000)
# C01_ELS.calculate_structure()

# #Plot and export data
# C01_ELS.plotStructure()
# C01_ELS.export_Data('CASO_01/CASO_01_ELS.xlsx')
# C01_ELS.export_DxfStructure('CASO_01/CASO_01_ELS.dxf')
...
C01_ELS_1YEAR.import_DxfStructure('CASO_01/CASO_01.dxf')
...
C01_ELS_1YEAR.set_P(75000, Memberfilter='Allmembers') #set the same pretension for all cables
...
#Structure analysis
C01_ELS_1YEAR.set_solverParameters(2000, 50, 5000)
C01_ELS_1YEAR.calculate_structure()

#Plot and export data
# C01_ELS_1YEAR.plotStructure(savePdf='CASO_01/CASO_01.pdf')
C01_ELS_1YEAR.export_Data('CASO_01/CASO_01_ELS_1YEAR.xlsx')
C01_ELS_1YEAR.export_DxfStructure('CASO_01/CASO_01_ELS_1YEAR.dxf')
...
C01_ELS_2YEAR.import_DxfStructure('CASO_01/CASO_01.dxf')
...
C01_ELS_2YEAR.set_P(75000, Memberfilter='Allmembers') #set the same pretension for all cables
...
#Structure analysis
C01_ELS_2YEAR.set_solverParameters(2000, 50, 5000)
C01_ELS_2YEAR.calculate_structure()

#Plot and export data
C01_ELS_2YEAR.plotStructure(savePdf='CASO_01/CASO_01.pdf')
C01_ELS_2YEAR.export_Data('CASO_01/CASO_01_ELS_2YEAR.xlsx')
C01_ELS_2YEAR.export_DxfStructure('CASO_01/CASO_01_ELS_2YEAR.dxf')